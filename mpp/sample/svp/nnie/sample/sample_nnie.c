...
/******************************************************************************
* function : print detection result  输出函数
******************************************************************************/
    ...
    SVP_BLOB_S *pstDstRoi, SVP_BLOB_S *pstClassRoiNum, HI_FLOAT f32PrintResultThresh)
{
    ...
    // SAMPLE_SVP_TRACE_INFO("u32RoiNumBias: %d\n",u32RoiNumBias);
    //printf("f32PrintResultThresh:%lf\n",f32PrintResultThresh);
    for (i = 1; i < u32ClassNum; i++)
    {
        u32ScoreBias = u32RoiNumBias;
        u32BboxBias = u32RoiNumBias * SAMPLE_SVP_NNIE_COORDI_NUM;
        //SAMPLE_SVP_TRACE_INFO("Thresh: %lf\n",(HI_FLOAT)ps32Score[u32ScoreBias]);
        //SAMPLE_SVP_TRACE_INFO("ps32ClassRoiNum[%d]: %d\n",i,ps32ClassRoiNum[i]);
...
{
    //HI_CHAR *pcSrcFile = "./data/nnie_image/rgb_planar/dog_bike_car_416x416.bgr";  // hub_2247_416.bgr 
    //HI_CHAR *pcModelName = "./data/nnie_model/detection/inst_yolov3_cycle.wk";   //    inst_yolov3_cycle.wk   hub_U8_8192T_inst.wk
    HI_CHAR *pcSrcFile = "./data/nnie_image/rgb_planar/hub_2247_416.bgr";
    HI_CHAR *pcModelName = "./data/nnie_model/detection/hub_U8_C821T_inst.wk";
    HI_U32 u32PicNum = 1;
    HI_FLOAT f32PrintResultThresh = 0.0f;
    HI_S32 s32Ret = HI_SUCCESS;
    SAMPLE_SVP_NNIE_CFG_S   stNnieCfg = {0};
    ...
    time_start = tps.tv_sec*1000+tps.tv_usec/1000;
    ...
    time_end = tpe.tv_sec*1000+tpe.tv_usec/1000;
    // comupte cost time
...
void SAMPLE_SVP_NNIE_Yolov3_Vivo(void)
{
 //   HI_CHAR *pcSrcFile = "./data/nnie_image/rgb_planar/dog_bike_car_416x416.bgr";   
    HI_CHAR *pcModelName = "./data/nnie_model/detection/hub_420_C821T_inst.wk";
    ...
    SAMPLE_SVP_TRACE_INFO("The s_stYolov3Model Height is %d\n", s_stYolov3Model.stModel.astSeg->astDstNode->unShape.stWhc.u32Height);
