...
HI_S32 SAMPLE_COMM_IVE_VbInit(PIC_SIZE_E *paenSize,SIZE_S *pastSize,HI_U32 u32VpssChnNum)
{
    ...
    for (i = 0; i < u32VpssChnNum; i++)
    {
        ...
        /*Real time YOLOV3 alter*/
        pastSize[1].u32Width = 448;
	    pastSize[1].u32Height = 448;
...
HI_S32 SAMPLE_COMM_IVE_StartVo(HI_VOID)
{
    ...
    printf("nnie VO_dev: %d\n",VoDev);
    printf("stVoPubAttr.enIntfType:%d\n",stVoPubAttr.enIntfType);
    printf("stVoPubAttr.enIntfSync:%d\n",stVoPubAttr.enIntfSync);
